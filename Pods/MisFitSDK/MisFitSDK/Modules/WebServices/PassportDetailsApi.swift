//
//  PassportDetailsApi.swift
//  MisFitSDK
//
//  Created by Shuvo on 3/28/22.
//

import Foundation
import UIKit

public class PassportDetailsApi {
    public init() {}
}
extension PassportDetailsApi {
//    public func apiPassportDetails(media1: UIImage?, completion : @escaping (JSON?) -> ()) {
//        if media1 == nil {
//            completion(nil)
//        }
//        let urlTo = URL(string: "\(baseUrl)api/v1/passports/details")!
...
//        }
//    }
    public func apiRequestForPassportDetails(media1: UIImage?, completion : @escaping (Any?) -> ()) {
        let Url = "\(baseUrl)api/v1/passports/details"
