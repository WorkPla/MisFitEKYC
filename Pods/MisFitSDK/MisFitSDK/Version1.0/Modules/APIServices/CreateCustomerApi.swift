...
extension CreateCustomerApi {
//    public func apiCreateCustomer(msisdn : String, name : String, dob : String, gender : String, nationality : String, address : String, employment_status : String, father_name : String, status : String, completion : @escaping (JSON?) -> ()) {
//
//        let urlTo = URL(string: "\(baseUrl)admin/api/v1/customers/")!
//        let parameters = [
//            "msisdn" : msisdn,
//            "name" : name,
//            "dob" : dob,
...
//    }
    ...
    public func apiRequestForCreateCustomer(msisdn : String, name : String, dob : String, gender : String, nationality : String, address : String, employment_status : String, father_name : String, status : String, completion : @escaping (Any?) -> ()) {
        let Url = "\(baseUrl)admin/api/v1/customers/"
