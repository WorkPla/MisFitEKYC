...
extension FaceDetectApi {
//    public func apiFaceDetect(media1: UIImage?, completion : @escaping (JSON?) -> ()) {
//        if media1 == nil {
//            completion(nil)
//        }
//        let urlTo = URL(string: "\(baseUrl)api/v1/face/detect")!
...
//    }
    ...
    public func apiRequestForFaceDetect(media1: UIImage?, completion : @escaping (Any?) -> ()) {
        let Url = "\(baseUrl)api/v1/face/detect"
