...
//  MisFitSDK
//
//  Created by Shuvo on 1/19/22.
//

import Foundation
import UIKit

let baseUrl = "http://ekyc.misfit-test.com/"
public class NRCDetailsApi {
    public init() {}
}
extension NRCDetailsApi {
//    public func apiNRCDetails(media1: UIImage?, completion : @escaping (JSON?) -> ()) {
//        if media1 == nil {
//            completion(nil)
//        }
//        let urlTo = URL(string: "\(baseUrl)api/v1/id_cards/details")!
...
//    }
    ...
    public func apiRequestForNrcCDetails(media1: UIImage?, completion : @escaping (Any?) -> ()) {
        let Url = "\(baseUrl)api/v1/id_cards/details"
