//
//  CambodianNRCDetailsApi.swift
//  MisFitSDK
//
//  Created by Shuvo on 4/27/22.
//

import Foundation
import UIKit

public class CambodianNRCDetailsApi {
    public init() {}
}
extension CambodianNRCDetailsApi {
//    public func apiCambodianNRCDetails(media1: UIImage?, completion : @escaping (JSON?) -> ()) {
//        if media1 == nil {
//            completion(nil)
//        }
//        let urlTo = URL(string: "\(baseUrl)api/v1/cambodian/predict")!
...
//    }
    ...
    public func apiRequestForCambodianNRCDetails(media1: UIImage?, completion : @escaping (Any?) -> ()) {
        let Url = "\(baseUrl)api/v1/cambodian/predict"
